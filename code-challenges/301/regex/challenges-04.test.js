...
Write a function named isNum that takes in a string or number of any length. This function should use a regular expression pattern to return true if the
...
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
 takes in an array of city names and uses a regular expression pattern to return a new array containing any 
cities that begin with the letters A through J, inclusive.
Write a function named citiesAtoJ that
------------------------------------------------------------------------------------------------ */
...
const citiesAtoJ = (arr) => {
  ...
  const newArr = [];
  arr.forEach((e)=>{
    let capRegex = /^([A-J])\w+/g
    let test = capRegex.test(e);
      if(test === true){
          newArr.push(e)
      }
  })
